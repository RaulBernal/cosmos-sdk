...
Example:
$ %s tx staking delegate bcnavalopers1l2rsakp388kuv9k8qzq6lrm9taddae7fpx59wm 1000stake --from mykey
`,
				version.AppName,
			),
		),
...
Example:
$ %s tx staking redelegate bcnavalopers1gghjut3ccd8ay0zduzj64hwre2fxs9ldmqhffj bcnavalopers1l2rsakp388kuv9k8qzq6lrm9taddae7fpx59wm 100stake --from mykey
`,
				version.AppName,
			),
		),
