...
require (
	...
	cosmossdk.io/core/testing v0.0.0-20240902195647-9197f541e5bc //
...
replace (
	...
	cosmossdk.io/collections => cosmossdk.io/collections v0.4.1-0.20240902195647-9197f541e5bc // main
	// pseudo version lower than the latest tag
