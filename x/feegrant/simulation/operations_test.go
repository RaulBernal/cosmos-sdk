...
func (suite *SimTestSuite) TestWeightedOperations() {
	...
	weightedOps := simulation.WeightedOperations(
		...
		suite.bankKeeper, suite.feegrantKeeper, codecaddress.NewBech32Codec("bcna"),
	)
...
func (suite *SimTestSuite) TestSimulateMsgRevokeAllowance() {
	...
	// execute operation
	op := simulation.SimulateMsgRevokeAllowance(codec.NewProtoCodec(suite.interfaceRegistry), suite.txConfig, suite.accountKeeper, suite.bankKeeper, suite.feegrantKeeper, codecaddress.NewBech32Codec("bcna"))
	operationMsg, futureOperations, err := op(r, app.BaseApp, ctx, accounts, "")
	require.NoError(err)
