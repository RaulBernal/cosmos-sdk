...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 1}, []string{"bcna", "params", "v1beta1"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Subspaces_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"bcna", "params", "v1beta1", "subspaces"}, "", runtime.AssumeColonVerbOpt(false)))
)
