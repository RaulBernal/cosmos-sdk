...
func (s *KeeperTestSuite) SetupTest() {
	...
	s.stakingKeeper.EXPECT().ValidatorAddressCodec().Return(address.NewBech32Codec("bcnavaloper")).AnyTimes()
	s.stakingKeeper.EXPECT().ConsensusAddressCodec().Return(address.NewBech32Codec("bcnavalcons")).AnyTimes()
