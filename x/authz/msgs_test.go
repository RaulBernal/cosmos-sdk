...
func TestAminoJSON(t *testing.T) {
	...
	require.NoError(t, err)
	valAddr, err := sdk.ValAddressFromBech32("bcnavaloper1xcy3els9ua75kdm783c3qu0rfa2eples6eavqq")
	require.NoError(t, err)
