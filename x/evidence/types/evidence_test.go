...
func TestEquivocation_Valid(t *testing.T) {
	...
	require.Equal(t, e.GetConsensusAddress(address.NewBech32Codec("bcnavalcons")).String(), e.ConsensusAddress)
	...
	require.Equal(t, "height:100 time:<seconds:1136214245 > power:1000000 consensus_address:\"bcnavalcons1vehk7h6lta047h6lta047h6lta047h6l8m4r53\" ", e.String())
	...
	require.Equal(t, e.ConsensusAddress, e.GetConsensusAddress(address.NewBech32Codec("bcnavalcons")).String())
